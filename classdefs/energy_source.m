classdef energy_source
    ...
    methods
        function obj = energy_source(M,InArg1,InArg2,InArg3)
            ...
            if nargin == 2
                ...
                % Assume if single species material - carry cost of
                % manufacture into Composition_exergy and Energy rather
                % than chemical 
            end
